...
public class Exercise4a {
    ...
    public static void main(String[] args) {
        ...
        message += "test2 without cheat: " + IntegerArrays.toString( test2 ) + "\n";
        IntegerArrays.sortDescCheat(test2);
        message += "test2 with cheat: " + IntegerArrays.toString( test2 ) + "\n";

        message += "test1: " + IntegerArrays.getMedian( test1 ) + "\n";
        message += "test2: " + IntegerArrays.getMedian( test2 ) + "\n";
